...
<br>
Two months ago when Do Recreation When Idle appeared on the Workshop, I couldn't help but shout.  
This mod was exactly what I wanted, but it didn't work perfectly in my colony.  
Thanks to publicly shared source code, I learned the basics of Harmony and conducted some experiments.  
<br>
...
So, This mod reduces joy gain to 1/1000 at 87.5%.  
...
<br>
If a colonist's joy somehow reaches 100%, they might briefly wander.  
To prevent this, the joy decay rate increases tenfold above 90%.  
Thus, any wandering will be very brief, and we can observe our colonists enjoying endless recreation.  
<br>
The mod only affects joy gain and decay, so it works with any recreation-adding mods.  
